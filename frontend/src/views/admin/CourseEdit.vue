    ...
    <a-form :form="form" @submit="handleSubmit">
      ...
      >
        <a-upload
          ...
          action="/api/upload/course_cover"
    ...
    return {
      ...
      editorConfig: {
        ...
        toolbar: [
          ...
          '|', 'indent', 'outdent', '|', 'ckfinder', 'imageUpload', 'blockQuote',
          'insertTable', 'mediaEmbed', 'undo', 'redo'
        ],
        ckfinder: {
          uploadUrl: '/api/upload/ckfinder',
          filebrowserBrowseUrl: '/images/ckfinder/',
          filebrowserImageBrowseUrl: '/images/ckfinder/',
          filebrowserUploadUrl: '/images/ckfinder/',
          filebrowserImageUploadUrl: '/images/ckfinder/'
        }
      },
      loading: false,
      disabled: false,
